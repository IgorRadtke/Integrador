...
try{
    ...
    if (isset($_POST['dataV'])){
        ...
        if (count($resultado)===0){
            ...
            header('Location: medidasCli.php');
            exit; 
        }
    }
?>
  ...
  <div class="container">
    ...
    <div class="menu">
        <nav class="navigation-menu">
            ...
            <ul class="list-nav">
                <li class="item-nav">
                    <a class="link-nav" href="Treinos_Cli.php">
    ...
    <div class="content">
        <div class="Avalia">
            <form action = "medidasCli.php" method = "Post"><br></h1><br>
                <h2> Caso já tenha medidas cadastradas, selecione ao lado a data que você deseja visualizar.
                    ...
                    ?>
                    <button type="submit"> Ver </button></h2>
            </form>
                
            <h1 class="title">Inclusão de Medidas</h1>
            <form action = "medidasCli.php" method = "Post"><br>
